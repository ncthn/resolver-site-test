...
| 4 | Compose: rebuild on the ComeDown Support compose pattern (production repo IS comedown-support: check its compose/outbound UI) | TODO |
...
| 8 | Settings > Stores: connection key per store + nicer UI | TODO |
| 9 | Settings > Policies & SOP: go much deeper PER STORE: list all rules, view/edit/create/delete, AI assistance | TODO |
| 10 | Settings > Email → "Emails"; add path for sending NOT via Gmail (own domain via Resolver, e.g. Postmark like production) | TODO |
...
| 13 | Orders context: show payment method, warning flag when PayPal or Klarna (check comedown-support integration for source field) | TODO |
